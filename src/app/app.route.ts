...
export const routes: Routes = [
  {
    ...
    data: { title: "Customer Appointment" },
  },
  {
    path: "",
...

  {
    ...
    children: [
      ...
      },
      {
        ...
        data: { title: "Finance Admin" },
      },
      {
        path: "crypto",
        component: CryptoComponent,
        data: { title: "Crypto Admin" },
      },
      {
        path: "add-student",
      ...
      {
        path: "close-slots",
        component: CloseslotsComponent,
        data: { title: "Close Slots" },
      },
      {
        path: "add-services",
      ...
      },
      {
        ...
        data: { title: "Assign Batch" },
      },
      {
        path: "assign-media",
        component: AssignMediaComponent,
        data: { title: "Assign Media" },
      },
      {
        path: "student-study-materials",
        component: StudentStudyMaterialsComponent,
        data: { title: "Student Study Materials" },
      },
      {
        path: "assign-topic",
        component: AssignTopicComponent,
        data: { title: "Assign Topic" },
      },
      {
        path: "upgrade-student-batch",
        component: UpgradeStudentBatchComponent,
        data: { title: "Upgrade Student Batch" },
      },
      {
        path: "add-topic",
      ...
      },
      {
        ...
        data: { title: "Student Certificates" },
      },
      {
        path: "student-receipts",
        component: StudentReceiptsComponent,
        data: { title: "Student Receipts" },
      },
      {
        path: "attendance",
